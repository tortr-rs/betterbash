...
bbash (pronounced behbash)is GNU Bash with a small, additive set of clearer-named commands
...
## cheers @tortr-rs [![ko-fi](https://ko-fi.com/img/githubbutton_sm.svg)](https://ko-fi.com/L6N725GI1V)
